...
public class DaumOauth2Controller {
    private static String daum_client_id = "5417700322733080664";      //본인 것으로 추가하기
    private static String daum_client_secret = "ccf0f0c39ccd221d15c6f3af304f7b5d";  //본인 것으로 추가하기
    ...
    private static String daum_rest_api_key = "18b5c6654fbc4d1d868cf0370eeafbdf";   //본인 것으로 추가하기
