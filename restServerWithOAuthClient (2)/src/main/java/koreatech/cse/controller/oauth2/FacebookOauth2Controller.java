...
public class FacebookOauth2Controller {
    private static String facebook_client_id = "357887721232499";      //본인 것으로 추가하기
    private static String facebook_client_secret = "6da0cee4c12c92314c2aac063aebd9b9";  //본인 것으로 추가하기
